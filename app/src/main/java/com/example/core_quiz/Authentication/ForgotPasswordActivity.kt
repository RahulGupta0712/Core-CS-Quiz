...
import com.example.core_quiz.databinding.ActivityForgotPasswordBinding
            ...
            if (email.isEmpty()) {
                ...
                auth.createUserWithEmailAndPassword(email, "dummyPassword")
                    .addOnSuccessListener {
                        ...
                        user.delete()
                        FancyToast.makeText(this,"User not registered",FancyToast.LENGTH_SHORT,FancyToast.ERROR,false).show()
                    }
                    .addOnFailureListener{exception ->
                        if(exception is FirebaseAuthUserCollisionException){
                            ...
                            auth.sendPasswordResetEmail(email)
                                .addOnSuccessListener {
                                    FancyToast.makeText(this,"Password Reset link sent to $email",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,false).show()
